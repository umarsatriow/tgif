    ...
    <div class="pane-content">
        ...
        <div class="pane-description">
            ...
            <div class="pane-buttons">
                <a id="preview-button-source"<?=($data['cookie']['new_window'] > 0 ? ' target="_blank"' : '')?> data-nd><div class="button button-neutral"><?=$lang['source']?></div></a>
...
<div id="images-results" class="images-results flex-images">
    <?php foreach($data['results'] as $result): ?>
        <div class="item image-frame" data-w="<?=$result['thumbnail']['width']?>" data-h="<?=$result['thumbnail']['height']?>" data-image-size="<?=e($result['width'])?> × <?=e($result['height'])?>" data-image-url="<?=e($result['contentUrl'])?>" data-image-name="<?=e($result['name'])?>" data-image-display-url="<?=e($result['displayUrl'])?>" data-image-host-url="<?=e($result['hostPageUrl'])?>">

...
<div id="header" class="header">
    <div class="header-content">
        <div class="header-col header-col-logo"><a href="<?=$data['url']?>/"><div class="logo"></div></a></div>
        <div class="header-col header-col-content"><?=(isset($data['search_bar_view']) ? $data['search_bar_view'] : '')?></div>
    ...
    <div class="row"><?=(isset($data['menu_view']) ? $data['menu_view'] : '')?></div>
</div>